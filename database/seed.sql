...
TRUNCATE TABLE product_compatibility;
...
VALUES
  ...
  (11, 9,  7, 'GAT-K015603XS', 'K015603XS',
   ...
   215000.00, 158000.00, 'ARS', 12, 0, 1),
  ...
  (13, 14, 9, 'MOU-M22GD', 'M22GD',
   ...
   185000.00, 135000.00, 'ARS', 22, 0, 1),
  ...
  (15, 15, 1, 'BOS-0124325045', '0124325045',
   ...
   295000.00, 210000.00, 'ARS', 8, 0, 1);

-- =============================================================
-- PRODUCT IMAGES (sample)
-- =============================================================
INSERT INTO product_images (product_id, url, alt_text, position, is_primary) VALUES
  (1,  'https://cdn.example.com/products/bos-of-1457429192-1.jpg', 'Filtro Bosch 1457429192',     0, 1),
  (1,  'https://cdn.example.com/products/bos-of-1457429192-2.jpg', 'Filtro Bosch vista lateral',  1, 0),
  (4,  'https://cdn.example.com/products/ngk-ifr6t11-1.jpg',       'Bujías NGK Iridium x4',       0, 1),
  (6,  'https://cdn.example.com/products/fer-fdb4456-1.jpg',       'Pastillas Ferodo FDB4456',    0, 1),
  (8,  'https://cdn.example.com/products/bos-bd0986479s32-1.jpg',  'Disco Bosch Corolla',         0, 1),
  (9,  'https://cdn.example.com/products/mon-g7330-1.jpg',         'Amortiguador Monroe G7330',   0, 1),
  (11, 'https://cdn.example.com/products/gat-k015603xs-1.jpg',     'Kit distribución Gates',      0, 1),
  (13, 'https://cdn.example.com/products/mou-m22gd-1.jpg',         'Batería Moura M22GD',         0, 1),
  (14, 'https://cdn.example.com/products/val-826869-1.jpg',        'Kit embrague Valeo',          0, 1),
  (15, 'https://cdn.example.com/products/bos-0124325045-1.jpg',    'Alternador Bosch',            0, 1);
...
-- NGK Standard plug (broad fitment, flex gasoline)
INSERT INTO product_compatibility (product_id, vehicle_id, position) VALUES
  (5, 1,  'universal'),
  (5, 4,  'universal'),
  (5, 11, 'universal'),
...
-- Moura Battery - universal fitment across the whole sample
INSERT INTO product_compatibility (product_id, vehicle_id, position) VALUES
...
INSERT INTO customers
  (id, customer_type, business_name, contact_name, email, phone, document_type, document_number, is_active)
VALUES
  (1, 'wholesale', 'Autopartes del Sur S.A.',   'Martín Gómez',    'ventas@autopartesdelsur.com.ar', '+54 11 4312-5600', 'CUIT', '30-71234567-8', 1),
  (2, 'workshop',  'Taller Mecánico Rodríguez', 'Luis Rodríguez',  'taller.rodriguez@gmail.com',     '+54 341 456-7890', 'CUIT', '20-22345678-9', 1),
  (3, 'retail',    NULL,                        'Juan Pérez',      'juan.perez@gmail.com',           '+54 11 5678-1234', 'DNI',  '32456789',      1),
  (4, 'workshop',  'Servicio Técnico González', 'Andrea González', 'andrea@stgonzalez.com.ar',       '+54 351 234-5678', 'CUIT', '27-24567891-3', 1);

-- =============================================================
-- ORDERS + ORDER_ITEMS (sample)
...
-- -------------------------------------------------------------
-- Order 1: Autopartes del Sur (wholesale, paid, shipped)
--   10 x 12500 + 5 x 85000 + 4 x 78000 = 862,000
--   IVA(21%) = 862000 / 1.21 * 0.21 = 149,603.31
...
INSERT INTO orders (
  ...
  '2026-04-01 10:15:00', '2026-04-01 14:30:00', '2026-04-02 11:00:00'
);
...
-- -------------------------------------------------------------
-- Order 2: Juan Pérez (retail, paid, delivered)
--   1 x 142000 + 1 x 128000 + 2 x 6500 = 283,000
--   IVA(21%) = 283000 / 1.21 * 0.21 = 49,115.70
...
INSERT INTO orders (
  ...
  '2026-04-10 18:22:00', '2026-04-10 18:25:00', '2026-04-11 09:00:00', '2026-04-13 14:20:00'
);
...
-- -------------------------------------------------------------
-- Order 3: Taller Mecánico Rodríguez (workshop, pending, preparing, on-account)
--   2 x 215000 + 1 x 485000 + 1 x 295000 = 1,210,000
--   IVA(21%) = 1210000 / 1.21 * 0.21 = 210,000.00
